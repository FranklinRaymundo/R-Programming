...
# Estructura basica : if( Expresión logica) Acción
a<-0 
if(a != 0) c("Holi")
if(a == 0 ) print("Boli")
if(a == 0) x<-"Holi"
...
## Pero existe otra que se llama ifelse :v
ifelse( a<5,c<-"a es menor a 5",c<-"a es mayor o igual a 5")
...
#Peso : Debe tener una correlacion mayor a .3 con la edad
